...
const city = cities["burnaby"];

export const metadata: Metadata = {
  title: `Used Cars for Sale Near ${city.name}, BC | ${dealership.name}`,
  description: `Used cars for sale near ${city.name}, BC. ${dealership.name} is just ${city.distanceFromCoquitlam} away in ${dealership.city}. Honest pricing, no surprise fees, financing available.`,
  alternates: { canonical: `/used-cars-${city.slug}` },
};

export default async function BurnabyPage() {
